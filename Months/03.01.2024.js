...
//What I learned today, if I want to change an integer to a string...I can use the .toString() method
//If I want to change the string back into an integer, I can use hte .parseInt() method
//These two methods are very useful for me to learn and remember for these types of math problems!